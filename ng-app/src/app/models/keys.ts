export class Keys {
  ...
  public static readonly JWT_RENEWAL_RETRY_DELAY_MS = 1000 * 20;
  ...
  public static readonly JWT_MIN_RENEW_WAIT_TIME_MS_DEFAULT = 1000 * 60 * 4; // 4 min wait time
  ...
  public static readonly DEFAULT_SNACKBAR_DURATION_MS = 2000;
  // Feature Toggles
